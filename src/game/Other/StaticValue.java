...
public class StaticValue {
        ...
        public static BufferedImage[] timeImage = new BufferedImage[5];
        ...
        public static void init() {
                try {
                        ...
                        timeImage = loadFrames("ui/time.png", 5);

                        // 加载PC图片
                        walk_U = loadFrames("characters/walk_u.png", 5);
                        walk_D = loadFrames("characters/walk_d.png", 5);
                        walk_L = loadFrames("characters/walk_l.png", 8);
                        walk_R = loadFrames("characters/walk_r.png", 8);
                        idle = walk_D[2];
                        ...
                        // 加载像素字体
                        pixelFont = java.awt.Font
                                        .createFont(java.awt.Font.TRUETYPE_FONT,
                                                        StaticValue.class.getClassLoader().getResourceAsStream(
        ...
        private static BufferedImage[] loadFrames(String filename, int frame) throws IOException {
                BufferedImage spriteSheet = ImageIO.read(Objects.requireNonNull(
                                StaticValue.class.getClassLoader().getResource("assets/" + filename),
                                "Resource not found: assets/" + filename));
                        ...
                        try {
                                plantTileset = ImageIO.read(Objects.requireNonNull(
                                                StaticValue.class.getClassLoader()
                                                                .getResource("assets/map/assets.png")));
                        } catch (IOException e) {
                                e.printStackTrace();
                                return null;
                        }
